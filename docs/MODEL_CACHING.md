...
- **pyannote**: `hub/models--pyannote--speaker-diarization-3.1/blobs/` (~250+ MB)
  - Used by: Agent 2 for speaker diarization (requires HF_TOKEN)
...
5. **Set HF_TOKEN**: Required for pyannote speaker diarization
