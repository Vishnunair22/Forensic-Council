...
async def analyze_image_content(
    ...
    try:
        ...
        semantic_templates = {
            ...
            "a photograph of a crowd or public gathering": "Crowd scene - composite insertion and region consistency check relevant",
            "a nighttime or low-light photograph": "Low-light scene - noise pattern, ISO, and sensor-level forensics applicable",
            "a landscape or nature photograph": "Landscape - lighting, horizon, and sky-gradient consistency applicable",
            "a photograph of a street scene or cityscape": "Street scene - object detection, temporal, and perspective forensics applicable",
            "a photograph of a vehicle or car": "Vehicle scene - plate, scale, and object proportion forensics applicable",
            "a photograph of a building or structure": "Architecture - perspective, shadow, and geometry forensics applicable",
            "a photograph of food or a meal": "Food photography - commercial manipulation and colour-grading check relevant",
            "a close-up photograph of an object or item": "Close-up object - scale, depth, and texture consistency applicable",
            "a satellite or aerial photograph": "Aerial imagery - geo-registration and shadow-sun-angle forensics applicable",
            "a medical or scientific imaging scan": "Medical imaging - provenance, chain-of-custody, and label-tampering critical",
            "a social media post": "Social media content - metadata gaps and re-compression footprint expected",
            "a surveillance camera frame": "Surveillance footage - low quality expected; frame integrity and timestamp critical",
            "a digitally generated or AI image": "Potentially AI-generated - diffusion artifact and watermark checks recommended",
            "a scanned photograph": "Scanned photo - print artifacts, halftone patterns, and flatbed noise may be present",
            "a news article image": "News media - editorial context and metadata provenance relevant",
