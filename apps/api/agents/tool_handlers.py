"""
Common tool handlers and heavy forensic logic wrappers.
Reduces agent bloat by centralizing reusable tool logic.
"""
...
class ToolHandlers:
    """Namespace for shared tool logic."""
