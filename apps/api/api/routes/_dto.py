...
def _forensic_report_to_dto(report) -> ReportDTO:
    ...
    return ReportDTO(
        ...
        per_agent_metrics=metrics if isinstance(metrics := _get_val(report, "per_agent_metrics", {}), dict) else {},
        per_agent_analysis=analysis if isinstance(analysis := _get_val(report, "per_agent_analysis", {}), dict) else {},
