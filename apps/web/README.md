...
Tests live in `apps/web/tests/` within the web app.
...
| `apps/web/tests/accessibility/` | WCAG 2.1 AA: keyboard nav, ARIA labels, focus management |
| `apps/web/tests/integration/` | Session data flow, report deduplication, auth lifecycle |
| `apps/web/tests/e2e/` | WebSocket full lifecycle, arbiter race fix, deep analysis flow |
