    ...
    <section className="py-24 px-6 bg-slate-900/10 rounded-t-[3rem] border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <motion.h2 
          ...
          viewport={{ once: true }}
          className="text-3xl md:text-5xl font-black text-center mb-16 tracking-tighter text-white"
        >
          Meet The Agents
        </motion.h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {AGENTS.map((agent, i) => (
            ...
            >
              <div className="p-5 bg-white/[0.03] rounded-2xl mb-8 group-hover:bg-cyan-500/10 transition-colors">
                <agent.icon
