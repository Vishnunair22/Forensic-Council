        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
          ...
          <div className="flex-1 text-center md:text-left space-y-4">
            <div>
              ...
              <p className="text-sm font-medium text-rose-200/40 leading-relaxed break-words">
                {message}
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2 justify-center md:justify-start">
              {showRetry && onRetry && (
                <button
                  onClick={onRetry}
                  className="btn-pill-primary px-8 py-3 text-[11px] font-bold gap-2 bg-rose-900/40 text-rose-200 hover:bg-rose-900 transition-all border border-rose-500/30"
                >
              ...
              {onDismiss && (
                <button
                  onClick={onDismiss}
                  className="btn-pill-secondary px-8 py-3 text-[11px] font-bold gap-2 border-white/5 active:scale-95"
                >
