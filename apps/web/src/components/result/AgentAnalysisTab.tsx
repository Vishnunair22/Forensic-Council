    ...
    <section aria-label="Agent analysis findings" className="bg-white/[0.01] border border-white/[0.04] rounded-2xl p-1">
      <div className="flex items-center justify-between gap-3 mb-4 px-4 pt-4">
        <div className="flex items-center gap-2.5">
          ...
          <h2 className="text-sm font-semibold fc-text-primary">Agent Findings</h2>
        </div>
        <div className="bg-white/[0.03] border border-white/10 px-2 py-0.5 rounded text-xs font-mono text-primary uppercase">
