...
All tests are fully self-contained — no real PostgreSQL connection required.
...
class MockPostgresClient:
    ...
    async def fetch_one(self, query: str, *args) -> Optional[dict[str, Any]]:
        ...
        # _get_last_entry_hash query — keyed by session_id, ORDER BY timestamp DESC
        ...
        # get_entry query — keyed by entry_id
