...
def detect_copy_move(image_path: str, descriptor_distance_threshold: float = 50.0,
                     spatial_distance_threshold: float = 30.0,
                     min_pairs_for_detection: int = 5) -> dict:
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--descriptor-threshold", type=float, default=50.0,
                        help="Maximum descriptor distance for a match")
    parser.add_argument("--spatial-threshold", type=float, default=30.0,
