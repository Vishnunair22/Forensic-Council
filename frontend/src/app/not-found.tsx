    ...
    <div className="min-h-screen text-foreground flex flex-col items-center justify-center p-6 text-center relative overflow-hidden">
      ...
      >
        ...
        <div className="space-y-2">
          <p className="text-indigo-400 font-mono text-xs tracking-[0.2em] uppercase">
            404 — Route Not Found
          </p>
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full">
          <Link
            href="/"
            className="flex-1 py-3 rounded-xl font-medium inline-flex items-center justify-center gap-2 text-white border border-cyan-400/30"
            style={{
