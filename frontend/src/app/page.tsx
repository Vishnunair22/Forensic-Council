            ...
            >
              ...
              <div className="flex justify-center">
                <button
                  ...
                  className="btn-pill-primary px-12 py-5 text-lg font-bold group shadow-[0_20px_50px_rgba(8,145,178,0.2)] hover:shadow-[0_20px_60px_rgba(8,145,178,0.4)] transition-all flex items-center gap-3 disabled:opacity-75 disabled:cursor-wait"
                >
                  {isAuthenticating ? (
                    <>
