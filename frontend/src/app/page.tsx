...
const AGENTS = [
  ...
  { id: "AGT-02", name: "Audio Forensics", icon: Mic, color: "#818cf8", bgRgb: "129,140,248", badge: "Acoustic Integrity", desc: "Wav2Vec2 deepfake detection and spectral analysis to catch voice cloning, audio splicing, and synthesis artefacts." },
  { id: "AGT-03", name: "Object Detection", icon: Crosshair, color: "#38bdf8", bgRgb: "56,189,248", badge: "Contextual Analysis", desc: "YOLOv8 lighting, shadow, and reflection anomaly detection to spot compositing errors and contextual inconsistencies." },
  { id: "AGT-04", name: "Video Forensics", icon: Video, color: "#2dd4bf", bgRgb: "45,212,191", badge: "Temporal Analysis", desc: "Frame-by-frame face-swap detection and temporal inconsistency scans across the full video timeline." },
  { id: "AGT-05", name: "Metadata Expert", icon: FileCode2, color: "#60a5fa", bgRgb: "96,165,250", badge: "Digital Footprint", desc: "EXIF/XMP extraction, GPS cross-reference, solar positioning checks, and device fingerprinting." },
...
const HOW_IT_WORKS = [
  ...
  { step: "02", icon: Cpu, title: "Multi-Agent Scan", desc: "Five specialist agents run parallel deep analysis on image, audio, video, and metadata evidence.", tag: "5 Agents Active", color: "#818cf8", rgb: "129,140,248" },
