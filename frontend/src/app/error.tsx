    ...
    return (
        <div className="min-h-screen text-foreground flex flex-col items-center justify-center p-6 text-center relative overflow-hidden">
            <motion.div
                ...
                style={{ backdropFilter: "blur(24px)", boxShadow: "0 32px 80px rgba(0,0,0,0.5), inset 0 1px 0 rgba(255,255,255,0.04)" }}
            ...
            >
                ...
                <div className="w-full space-y-3">
                    <motion.button
                        ...
                        whileHover={{ scale: 1.02, boxShadow: "0 0 32px rgba(34,211,238,0.28)" }}
                        whileTap={{ scale: 0.98 }}
                    >
                    ...
                    <Link href="/" className="w-full py-3.5 rounded-xl inline-flex items-center justify-center gap-2 font-semibold text-white/80 bg-white/[0.04] border border-white/[0.09] hover:bg-cyan-500/[0.07] hover:border-cyan-500/28 hover:text-cyan-400 transition-colors">
