...
export const AgentIcon = ({
  ...
  if (r.includes("integrity") || r.includes("artifact"))
    return <Shield {...iconProps} />;
  if (
    r.includes("scene") ||
    r.includes("lighting") ||
    r.includes("reconstruction")
  )
    return <Search {...iconProps} />;
  if (r.includes("object") || r.includes("weapon"))
    return <Layout {...iconProps} />;
  if (r.includes("temporal") || r.includes("video") || r.includes("frame"))
    return <Video {...iconProps} />;
  if (r.includes("metadata") || r.includes("context"))
    return <Database {...iconProps} />;
  if (r.includes("audio") || r.includes("multimedia"))
    return <Mic2 {...iconProps} />;
  if (r.includes("arbiter") || r.includes("synthesis"))
