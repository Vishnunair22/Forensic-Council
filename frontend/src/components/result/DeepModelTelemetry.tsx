...
export function DeepModelTelemetry({ report }: DeepModelTelemetryProps) {
  ...
  return (
    <div className="rounded-2xl overflow-hidden glass-panel border border-violet-500/20 bg-violet-500/[0.02]">
      <div className="px-5 py-3.5 border-b border-white/[0.05] bg-white/[0.02] flex items-center justify-between">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-[8px] font-mono font-bold text-violet-400/70 uppercase tracking-tighter">
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between relative z-10">
                  ...
                  <span className="text-[9px] font-mono text-violet-400 font-black">
                    {avgConf}%
                  </span>
                </div>
                ...
                <div className="flex justify-between items-center text-[8px] font-mono text-foreground/30 relative z-10">
                  <span>LOGIC: TENSOR_V4</span>
